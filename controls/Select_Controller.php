 ...
 * @since 1.0.0
 */
class Select_Controller extends \Elementor\Base_Control {
	...
	public function enqueue() {
		...
		wp_register_script( 'select-control', plugin_dir_url( __DIR__ ).'assets/js/select-control.js', [ 'jquery' ], '1.0.0' );
		wp_enqueue_script( 'select-control' );
	}
	...
	public function content_template() { 
		...
		<div>
			...
			<select class="post-select" name="" id="">
